                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="item in items" v-bind:key="item.id">
                                ...
                                <td>{{item.price}}</td>
                                <td><button class="btn btn-success" v-on:click="updateItem(item.id)">Update</button></td>
                                <td><button class="btn btn-warning" v-on:click="deleteItem(item.id)">Delete</button></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="row">
